...
export class Migration1773013861936 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."employees_status_enum" AS ENUM('active', 'suspended', 'deleted')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."employers_status_enum" RENAME TO "employers_status_enum_old"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."employers_status_enum" AS ENUM('active', 'suspended', 'deleted')`,
    );
    await queryRunner.query(`ALTER TABLE "employers" ALTER COLUMN "status" DROP DEFAULT`);
    await queryRunner.query(
      `ALTER TABLE "employers" ALTER COLUMN "status" TYPE "public"."employers_status_enum" USING "status"::"text"::"public"."employers_status_enum"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."employers_status_enum_old" AS ENUM('active', 'suspended')`,
    );
    await queryRunner.query(`ALTER TABLE "employers" ALTER COLUMN "status" DROP DEFAULT`);
    await queryRunner.query(
      `ALTER TABLE "employers" ALTER COLUMN "status" TYPE "public"."employers_status_enum_old" USING "status"::"text"::"public"."employers_status_enum_old"`,
    );
    await queryRunner.query(`ALTER TABLE "employers" ALTER COLUMN "status" SET DEFAULT 'active'`);
    await queryRunner.query(`DROP TYPE "public"."employers_status_enum"`);
    await queryRunner.query(
      `ALTER TYPE "public"."employers_status_enum_old" RENAME TO "employers_status_enum"`,
    );
