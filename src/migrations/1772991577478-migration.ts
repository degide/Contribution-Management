...
export class Migration1772991577478 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_e05c58bbdf174466081e1cfbea" ON "employees" ("national_id") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."employers_sector_enum" AS ENUM('public', 'private', 'ngo', 'parastatal')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."employers_status_enum" AS ENUM('active', 'suspended')`,
    );
    await queryRunner.query(
      `CREATE TABLE "employers" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "tin" character varying NOT NULL, "sector" "public"."employers_sector_enum" NOT NULL, "registration_date" date NOT NULL DEFAULT ('now'::text)::date, "status" "public"."employers_status_enum" NOT NULL DEFAULT 'active', "phone" character varying, "address" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_ddca441565747fd3c0a4e614d3f" UNIQUE ("tin"), CONSTRAINT "PK_f2c1aea3e8d7aa3c5fba949c97d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_ddca441565747fd3c0a4e614d3" ON "employers" ("tin") `,
    );
    await queryRunner.query(
      `ALTER TABLE "declarations" ADD CONSTRAINT "FK_d72727a4e01a87278a7090f0370" FOREIGN KEY ("employer_id") REFERENCES "employers"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "contribution_lines" ADD CONSTRAINT "FK_0cd22b30dbdabbd8ed652012b1e" FOREIGN KEY ("declaration_id") REFERENCES "declarations"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "contribution_lines" ADD CONSTRAINT "FK_157cf68d3f90a29dc4a7f499e49" FOREIGN KEY ("employee_id") REFERENCES "employees"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "employees" ADD CONSTRAINT "FK_ebeb3f3873766df45f15e9614bb" FOREIGN KEY ("employer_id") REFERENCES "employers"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "employees" DROP CONSTRAINT "FK_ebeb3f3873766df45f15e9614bb"`,
    );
    await queryRunner.query(
      `ALTER TABLE "contribution_lines" DROP CONSTRAINT "FK_157cf68d3f90a29dc4a7f499e49"`,
    );
    await queryRunner.query(
      `ALTER TABLE "contribution_lines" DROP CONSTRAINT "FK_0cd22b30dbdabbd8ed652012b1e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "declarations" DROP CONSTRAINT "FK_d72727a4e01a87278a7090f0370"`,
    );
