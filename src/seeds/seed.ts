...
const AppDataSource = new DataSource({
  ...
  username: process.env.DB_USERNAME || 'rssb_user',
  password: process.env.DB_PASSWORD || 'rssb_password',
  database: process.env.DB_NAME || 'rssb_db',
...
async function seed() {
  ...
  try {
    ...
    const teaEmployees = [
      { nationalId: '1199080123456001', firstName: 'Jean', lastName: 'Habimana', dob: '1990-03-12', hire: '2018-01-15', salary: 450000 },
      { nationalId: '1198570234567002', firstName: 'Marie', lastName: 'Uwimana', dob: '1985-07-22', hire: '2019-06-01', salary: 620000 },
      { nationalId: '1199200345678003', firstName: 'Pierre', lastName: 'Nkurunziza', dob: '1992-11-05', hire: '2020-03-01', salary: 380000 },
      { nationalId: '1198880456789004', firstName: 'Claudine', lastName: 'Mukamana', dob: '1988-01-30', hire: '2017-09-01', salary: 550000 },
      { nationalId: '1199540567890005', firstName: 'Emmanuel', lastName: 'Bizimana', dob: '1995-04-18', hire: '2021-07-15', salary: 420000 },
    ];
    ...
    const constructEmployees = [
      { nationalId: '1199160678901006', firstName: 'Alexis', lastName: 'Ntirenganya', dob: '1991-06-14', hire: '2016-04-01', salary: 700000 },
      { nationalId: '1198640789012007', firstName: 'Solange', lastName: 'Ingabire', dob: '1986-09-25', hire: '2018-11-01', salary: 850000 },
      { nationalId: '1199310890123008', firstName: 'Patrick', lastName: 'Rutayisire', dob: '1993-02-08', hire: '2020-01-15', salary: 480000 },
      { nationalId: '1198920901234009', firstName: 'Jacqueline', lastName: 'Nyiranziza', dob: '1989-12-20', hire: '2019-03-01', salary: 560000 },
      { nationalId: '1199740012345010', firstName: 'Olivier', lastName: 'Habiyaremye', dob: '1997-08-03', hire: '2022-05-01', salary: 400000 },
    ];
    ...
    async function createDeclaration(
      ...
      const [decl] = await q.query(`
        ...
        RETURNING id
      `, [
        paymentNumber, employerId, period, status,
        ['submitted', 'validated', 'rejected'].includes(status) ? new Date() : null,
        status === 'validated' ? new Date() : null,
      ]);

      let totalPension = 0, totalMedical = 0, totalMaternity = 0, grandTotal = 0;
